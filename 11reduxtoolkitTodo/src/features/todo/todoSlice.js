...
export const todoSlice = createSlice({
    ...
    reducers : {             //reducers ek object hai jiske andar properties and function aayenge
        addTodo: (state,action) => {   //addTodo me f2 cheezo ka access rahega  state initial state ki situation ke baar eme batata hai action methods ko call krne ke values deta hai jaise id wagera
            const todo = {
                id: nanoid(),
